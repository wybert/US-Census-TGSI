...
SELECT 'Loading tweets for 2020-10...';
...
-- Step 4: Save results
SELECT 'Saving results to /n/netscratch/cga/Lab/xiaokang/US-Census-TGSI-workspace/data/tweets_with_census_blocks/2020/2020_10.parquet...';
COPY tweets_with_blocks
TO '/n/netscratch/cga/Lab/xiaokang/US-Census-TGSI-workspace/data/tweets_with_census_blocks/2020/2020_10.parquet'
